        ...
        <div class="card-body">
            ...
            <form method="post" enctype="multipart/form-data" action="{{url('/pelaporan/store')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kategori_pelaporan" class="form-control" placeholder="Nama Kategori Pelaporan .." value="" disabled>
                    <input type="hidden" name="kategori_pelaporan" value="">
